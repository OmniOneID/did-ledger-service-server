...
public class DidDocumentRevokedDto {
    ...
    public static DidDocumentRevokedDto fromDidDocumentRevoked(DidDocumentRevoked didDocumentRevoked) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

        return DidDocumentRevokedDto.builder()
