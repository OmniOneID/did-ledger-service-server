...
import org.omnione.did.repository.v1.agent.dto.zkp.InputZkpCredentialDefinitionReqDto;
import org.omnione.did.repository.v1.agent.service.query.ZkpCredentialDefinitionQueryService;
import org.omnione.did.repository.v1.agent.service.query.ZkpCredentialSchemaQueryService;
...
public class ZkpCredentialDefinitionServiceImpl implements ZkpCredentialDefinitionService {
    ...
    public void generateZkpCredentialDefinition(InputZkpCredentialDefinitionReqDto request) {
        ...
        log.debug("\t--> Decoding and parsing credential definition");
        ...
        log.debug("\t--> Validating credential definition");
        // 2. validate the credential definition
        validateCredentialDefinition(credentialDefinition);

        log.debug("\t--> Checking if credential schema exists");
        ...
        log.debug("\t--> Checking if credential definition already exists");
