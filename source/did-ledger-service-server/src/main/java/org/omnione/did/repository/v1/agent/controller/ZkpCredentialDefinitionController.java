...
import org.omnione.did.repository.v1.agent.service.ZkpCredentialDefinitionService;
...
@RestController
@RequestMapping(value = UrlConstant.LSS.AGENT_V1  + UrlConstant.CREDENTIAL_DEFINITION)
public class ZkpCredentialDefinitionController {
    ...
    @ArticleLog(name = "[ZKP Credential Definition] Generate ZKP Credential Definition", apiType = ApiType.AGENT,
            targetType = "CREDENTIAL_DEFINITION", actionType = ActionType.CREATE)
    @PostMapping
    @ResponseBody
