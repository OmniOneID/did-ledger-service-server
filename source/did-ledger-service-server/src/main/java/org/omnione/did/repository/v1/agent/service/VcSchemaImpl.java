...
public class VcSchemaImpl implements VcSchemaService {
    ...
    public String getVcSchema(String schemaId) {
        ...
        log.debug("\t--> Finding VC Schema by schema ID: {}", schemaId);
        ...
        log.debug("\t--> Converting schema to JSON");
