...
public class DidDocumentStatusHistoryDto {
    private final Long id;
    private final Long didId;
    ...
    public static DidDocumentStatusHistoryDto fromDidDocumentStatusHistory(DidDocumentStatusHistory history) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

        return DidDocumentStatusHistoryDto.builder()
                .id(history.getId())
                .didId(history.getDidId())
                .did(null)
    ...
    public static DidDocumentStatusHistoryDto fromDidDocumentStatusHistory(DidDocumentStatusHistory history, String did) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
